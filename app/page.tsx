  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0a0a0a', color: 'white', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div style={{ position: 'relative' }}>
            <button
              ...
              style={{ padding: '7px 10px', borderRadius: 8, border: `1px solid ${unreadCount > 0 ? 'rgba(251,191,36,0.4)' : '#222'}`, background: unreadCount > 0 ? 'rgba(251,191,36,0.08)' : 'transparent', cursor: 'pointer', position: 'relative', color: unreadCount > 0 ? '#fbbf24' : '#555', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
            >
      ...
      <div style={{ maxWidth: 600, margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{
          background: '#111',
          border: `1px solid ${hasContact ? 'rgba(74,222,128,0.2)' : 'rgba(248,113,113,0.35)'}`,
          borderRadius: 16, padding: 24, marginBottom: 16,
          boxShadow: hasContact ? 'none' : '0 0 30px rgba(248,113,113,0.06)'
        }}>
          {/* Header row */}
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 12, gap: 12 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: '#444' }}>If you don't check in before the grace period ends</div>
              </div>
            </div>
            {/* Status pill */}
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <input type="email" placeholder="their@email.com" value={contactEmail} onChange={e => setContactEmail(e.target.value)} onKeyDown={e => e.key === 'Enter' && saveContact()}
              style={{ flex: 1, padding: '10px 14px', fontSize: 14, border: '1px solid #2a2a2a', borderRadius: 8, outline: 'none', background: '#0a0a0a', color: 'white', fontFamily: 'inherit' }} />
            <button onClick={saveContact} disabled={savingContact || !contactEmail}
              style={{ padding: '10px 20px', background: 'transparent', color: contactEmail ? '#4ade80' : '#333', border: `1px solid ${contactEmail ? 'rgba(74,222,128,0.4)' : '#222'}`, borderRadius: 8, cursor: savingContact || !contactEmail ? 'not-allowed' : 'pointer', fontWeight: 600, fontSize: 14, whiteSpace: 'nowrap', fontFamily: 'inherit', transition: 'all 0.2s' }}>
              {savingContact ? '...' : 'Save'}
            </button>
          </div>
          ...
          <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1, minWidth: 160, background: '#0f0f0f', border: '1px solid #1f1f1f', borderRadius: 14, padding: 20 }}>
              ...
              {['1 emergency contact', '24h + 1hr grace timer', 'In-app notifications'].map(f => (
                <div key={f} style={{ display: 'flex', gap: 8, marginBottom: 7, fontSize: 12, color: '#444' }}>
            ...
            <div style={{ flex: 1, minWidth: 160, background: '#0f0f0f', border: '1px solid rgba(74,222,128,0.3)', borderRadius: 14, padding: 20, boxShadow: '0 0 28px rgba(74,222,128,0.07)', position: 'relative' }}>
              ...
              {['Up to 5 contacts', 'Instant email alerts', 'Custom timers', 'Check-in history'].map(f => (
                <div key={f} style={{ display: 'flex', gap: 8, marginBottom: 7, fontSize: 12, color: '#666' }}>
            ...
            <div style={{ flex: 1, minWidth: 160, background: '#0f0f0f', border: '1px solid rgba(96,165,250,0.3)', borderRadius: 14, padding: 20, boxShadow: '0 0 28px rgba(96,165,250,0.07)', position: 'relative' }}>
              <div style={{ position: 'absolute', top: -11, left: '50%', transform: 'translateX(-50%)', background: '#1d4ed8', color: 'white', fontSize: 10, fontWeight: 700, padding: '3px 12px', borderRadius: 20, whiteSpace: 'nowrap', letterSpacing: '0.06em' }}>COMING SOON</div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
