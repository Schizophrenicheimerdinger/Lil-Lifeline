...
export default function Home() {
  ...
  return (
    <main style={{ background: '#0a0a0a', color: 'white', minHeight: '100vh', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '18px 32px', borderBottom: '1px solid #1f1f1f', background: 'rgba(10,10,10,0.85)', backdropFilter: 'blur(12px)', position: 'sticky', top: 0, zIndex: 100 }}>
      ...
      <section style={{ padding: '80px 24px', maxWidth: 640, margin: '0 auto' }}>
        ...
        {[['👤', 'Create your account', 'Sign up in 2 minutes with just your email and password.'], ['📬', 'Add an emergency contact', 'Enter the email of someone you trust — a family member, friend, or neighbour.'], ['✅', 'Check in daily', 'Open the app once a day and press I am Okay. Simple as that.'], ['⚠️', 'Miss it, they are notified', 'If 24 hours pass without a check-in, your contacts automatically receive an alert.']].map(([emoji, title, desc], i) => (
          <div key={i} style={{ display: 'flex', gap: 20, padding: '24px 0', borderBottom: '1px solid #1a1a1a' }}>
            <div style={{ width: 46, height: 46, borderRadius: '50%', background: 'rgba(74,222,128,0.08)', border: '1px solid rgba(74,222,128,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, flexShrink: 0 }}>{emoji}</div>
      ...
      <section style={{ padding: '80px 24px', background: '#050505' }}>
        ...
        <div style={{ display: 'flex', gap: 20, maxWidth: 960, margin: '0 auto', flexWrap: 'wrap' as const, justifyContent: 'center' }}>
          ...
          <div style={{ flex: 1, minWidth: 220, background: '#111', border: '1px solid rgba(74,222,128,0.35)', borderRadius: 16, padding: 28, position: 'relative', boxShadow: '0 0 30px rgba(74,222,128,0.08)' }}>
            <div style={{ position: 'absolute', top: -13, left: '50%', transform: 'translateX(-50%)', background: '#16a34a', color: 'white', fontSize: 11, fontWeight: 700, padding: '4px 14px', borderRadius: 20, whiteSpace: 'nowrap' as const, letterSpacing: '0.06em' }}>MOST POPULAR</div>
          ...
          <div style={{ flex: 1, minWidth: 220, background: '#111', border: '1px solid rgba(96,165,250,0.3)', borderRadius: 16, padding: 28, position: 'relative', boxShadow: '0 0 30px rgba(96,165,250,0.06)' }}>
            <div style={{ position: 'absolute', top: -13, left: '50%', transform: 'translateX(-50%)', background: '#1d4ed8', color: 'white', fontSize: 11, fontWeight: 700, padding: '4px 14px', borderRadius: 20, whiteSpace: 'nowrap' as const, letterSpacing: '0.06em' }}>BEST VALUE</div>
